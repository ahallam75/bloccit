...
router.post("/topics/:topicId/posts/create", validation.validatePosts, topicController.create);
...
router.post("/topics/:topicId/posts/:id/update", validation.validatePosts, topicController.update);
